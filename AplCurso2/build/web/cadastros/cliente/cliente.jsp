                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>ID PESSOA</label> <input class="form-control" type="text" name="idpessoa" id="idpessoa" value="" 
                               readonly="readonly"/>
                        <label>ID CLIENTE</label> <input class="form-control" type="text" name="idcliente" id="idcliente" 
...
<script>
    ...
    function setDadosModal(valor) {
        ...
        if (idFor != "0"){
            ...
            $.getJSON('ClienteCarregar', {idCliente: idFor}, function(respostaServlet){
    ...
    function carregarPessoa(v) {
        ...
        $(document).ready(function () {
            $.getJSON('PessoaBuscarCpfCnpj', {cpfcnpjpessoa: idM, tipopessoa: tipoPessoa}, function (respostaCli) {
                ...
                //var id = respostaFor.idCliente;
                if (respostaFor != null)
                {
                    $('#idcliente').val(respostaFor.idCliente);
                    $('#permitelogin').val(respostaFor.permiteLogin);
                    $('#observacao').val(respostaFor.observacao);
    ...
    function validarCampos() {
        ...
        if (document.getElementById("nomepessoa").value == '') {
            ...
            $("#nome").focus();
        } else if (document.getElementById("observacao").value == 'nulo') {
            Swal.fire({
                position: 'center',
                icon: 'error',
                title: 'Verifique a Observacao!',
                showConfirmButton: true,
                timer: 2000
            });
            $("#idcidade").focus();
